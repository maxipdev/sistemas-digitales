...
**¿Cómo ejecuto los test?**

Primero es nescesario abrir el taller en el *modo* 'contenedor', y luego para ejecutarlos hay que escribir en la terminal `make sim` dentro de la carpeta del ejercicio
...
El material de estudio disponible es el otorgado por la catedra. El mismo son las presentaciones utlizadas al momento de dar la clase
